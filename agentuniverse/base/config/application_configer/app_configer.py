...
class AppConfiger(object):
    ...
    def load_by_configer(self, configer: Configer) -> 'AppConfiger':
        ...
        core_package = configer.value.get('CORE_PACKAGE')
        ...
        self.__core_default_package_list = core_package.get('default')
        self.__core_agent_package_list = core_package.get('agent')
        self.__core_knowledge_package_list = core_package.get('knowledge')
        self.__core_llm_package_list = core_package.get('llm')
        self.__core_planner_package_list = core_package.get('planner')
        self.__core_tool_package_list = core_package.get('tool')
        self.__core_toolkit_package_list = core_package.get('toolkit')
        self.__core_memory_package_list = core_package.get('memory')
        self.__core_service_package_list = core_package.get('service')
        self.__core_sqldb_wrapper_package_list = core_package.get('sqldb_wrapper')
        self.__core_prompt_package_list = core_package.get('prompt')
        self.__core_product_package_list = core_package.get('product')
        self.__core_workflow_package_list = core_package.get('workflow')
        self.__core_embedding_package_list = core_package.get('embedding')
        self.__core_doc_processor_package_list = core_package.get('doc_processor')
        self.__core_reader_package_list = core_package.get('reader')
        self.__core_store_package_list = core_package.get('store')
        self.__core_rag_router_package_list = core_package.get('rag_router')
        self.__core_query_paraphraser_package_list = core_package.get('query_paraphraser')
        self.__core_memory_compressor_package_list = core_package.get('memory_compressor')
        self.__core_memory_storage_package_list = core_package.get('memory_storage')
        self.__core_work_pattern_package_list = core_package.get('work_pattern')
        self.__core_log_sink_package_list = core_package.get('log_sink')
        self.__core_llm_channel_package_list = core_package.get('llm_channel')
